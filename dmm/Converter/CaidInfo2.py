		...
		if os.path.isfile('/tmp/ecm.info'):
			...
			if filedata:
				for line in filedata.readlines():
					if 'cw0:' in line:
						reader_data1 = line.strip()
					elif 'cw1:' in line:
						reader_data2 = line.strip()
					info = "%s\n%s" % (reader_data1, reader_data2)
				filedata.close()
		return info
